...
" + " Seed:23490";
	...
	if(file_exists(global.alias + " 2019-03-17 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-03-17 Daily.txt");
		while(!file_loaded(global.alias + " 2019-03-17 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-03-17 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-03-17 Daily.txt");
	}
	if(global.qualified){
