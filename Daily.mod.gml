...
/*@rMods@w=#  Airhorn#  Ash#  Balls#  6 Weapons#  !ARMAGGEDNN#@bCharacter@w=#  Ash#@yCrown@w=#  crown of blood#@gWeapon@w=#  Cyber Shovel#@pSeed@w=18141*/
...
trace("Current Daily:");
trace("Mods=Airhorn,Ash,Balls,6 Weapons,!ARMAGGEDNN");
trace("Character=Ash");
trace("Crown=crown of blood");
trace("Weapon=Cyber Shovel");
trace("Seed=18141");
...
if(global.start){
	global.alias = "";
	with(Player){
		give_wep(string_trim("Cyber Shovel"));
		ammo[0] = 0;
		ammo[1] = 0;
		ammo[2] = 0;
		ammo[3] = 0;
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Airhorn,Ash,Balls,6 Weapons,!ARMAGGEDNN" + " Character=Ash" + " Crown=crown of blood" + " Weapon=Cyber Shovel" + " Seed=18141";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Airhorn,Ash,Balls,6 Weapons,!ARMAGGEDNN" + " Character=Ash" + " Crown=crown of blood" + " Weapon=Cyber Shovel" + " Seed=18141" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:Airhorn,Ash,Balls,6 Weapons,!ARMAGGEDNN" + " Character=Ash" + " Crown=crown of blood")) > 1){
			file_delete("sha.txt");
