...
/*@rMods@w=#  Auto Flame Crossbow#  Determination#  Devastator#  Doctor#  Corsair#@bCharacter@w=#  Choose#@yCrown@w=#  crown of haste#@gWeapon@w=#  Auto Flame Crossbow#@pSeed@w=26190#Limited Tries:false*/
/*|Auto Flame Crossbow[If flames were good this would be better than just looking cool...]|Determination[Seeing this filler text#fills you with determination]|Devastator[Changes the devastator#to make it more interesting]|Doctor[The feathery, creepy,#totally-not-about-to-#stab-you-with-a-knife#doctor is in!]|Corsair[The Corsair from EtG#Plot A Course]*/
#define init
...
trace("Current Daily:");
trace("Mods=Auto Flame Crossbow,Determination,Devastator,Doctor,Corsair");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Auto Flame Crossbow,Determination,Devastator,Doctor,Corsair" + " Character:Choose" + " Crown:crown of haste" + " Weapon:Auto Flame Crossbow" + " Seed:26190";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-25 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-25 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-25 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-25 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-25 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Auto Flame Crossbow,Determination,Devastator,Doctor,Corsair" + " Character:Choose" + " Crown:crown of haste" + " Weapon:Auto Flame Crossbow" + " Seed:26190" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Auto Flame Crossbow,Determination,Devastator,Doctor,Corsair" + " Character:Choose" + " Crown:crown of haste" + " Weapon:Auto Flame Crossbow" + " Seed:26190",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
