...
/*@rMods@w=#  Cursed Hyper Crystal#  Blindness#  Crazy Traps#  Cool Trails#  Determination#@bCharacter@w=#  Choose#@yCrown@w=#  crown of destiny#@gWeapon@w=#  eggplant#@pSeed@w=14864#Limited Tries:false*/
/*|Cursed Hyper Crystal[Adds a Cursed variant of the Hyper Crystal.#If you fight it you'll probably die,#but man does it look cool.]|Blindness[MY GLASSES! I BROKE MY GLASSES!]|Crazy Traps[Not only does#this place flame traps everywhere,#they have random projectiles, too!#Have fun with disc traps....]|Cool Trails[Bullet trails,#for when you want to feel#like you're in the matrix]|Determination[Seeing this filler text#fills you with determination]*/
#define init
...
trace("Current Daily:");
trace("Mods=Cursed Hyper Crystal,Blindness,Crazy Traps,Cool Trails,Determination");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Cursed Hyper Crystal,Blindness,Crazy Traps,Cool Trails,Determination" + " Character:Choose" + " Crown:crown of destiny" + " Weapon:eggplant" + " Seed:14864";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-10-24 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-10-24 Daily.txt");
		while(!file_loaded(global.alias + " 2019-10-24 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-10-24 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-10-24 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Cursed Hyper Crystal,Blindness,Crazy Traps,Cool Trails,Determination" + " Character:Choose" + " Crown:crown of destiny" + " Weapon:eggplant" + " Seed:14864" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Cursed Hyper Crystal,Blindness,Crazy Traps,Cool Trails,Determination" + " Character:Choose" + " Crown:crown of destiny" + " Weapon:eggplant" + " Seed:14864",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
