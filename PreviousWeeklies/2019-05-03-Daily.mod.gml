...
/*@rMods@w=#  Bear#  Champions#  Chest Bandits#  Blindness#  Defect#@bCharacter@w=#  Choose#@yCrown@w=#  crown of love#@gWeapon@w=#  A Fucking Gun#@pSeed@w=1292#Limited Tries:false*/
/*|Bear[4 da meeeeeeeeee#eeeeemez]|Champions[weeeee are the buffed minionssss,#my frieeeeeendssss]|Chest Bandits[Gets rid of bandits in random areas]|Blindness[MY GLASSES! I BROKE MY GLASSES!]|Defect[BEEP BOOP I AM ROBOT]*/
#define init
...
trace("Current Daily:");
trace("Mods=Bear,Champions,Chest Bandits,Blindness,Defect");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Bear,Champions,Chest Bandits,Blindness,Defect" + " Character:Choose" + " Crown:crown of love" + " Weapon:A Fucking Gun" + " Seed:1292";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-05-03 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-05-03 Daily.txt");
		while(!file_loaded(global.alias + " 2019-05-03 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-05-03 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-05-03 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Bear,Champions,Chest Bandits,Blindness,Defect" + " Character:Choose" + " Crown:crown of love" + " Weapon:A Fucking Gun" + " Seed:1292" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Bear,Champions,Chest Bandits,Blindness,Defect" + " Character:Choose" + " Crown:crown of love" + " Weapon:A Fucking Gun" + " Seed:1292",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
