...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	...
	if(file_exists(global.alias + " 2019-03-15 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-03-15 Daily.txt");
		while(!file_loaded(global.alias + " 2019-03-15 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-03-15 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-03-15 Daily.txt");
	}
	if(global.qualified){
...
file_delete(string_trim(data+name));while (file_exists(string_trim(data+name))) {wait 1;}wait(file_download(string_trim(Github + name), string_trim(data+name)));
