...
/*@pDesc@w=Do you have the luck o' the irish?#@rMods@w=#  Clasweps#@bCharacter@w=#  Choose#@yCrown@w=#  slots#@gWeapon@w=#  slot machine#@pSeed@w=11897#Limited Tries:false*/
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Clasweps," + " Character:Choose" + " Crown:slots" + " Weapon:slot machine" + " Seed:11897";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Clasweps," + " Character:Choose" + " Crown:slots" + " Weapon:slot machine" + " Seed:11897" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Clasweps," + " Character:Choose" + " Crown:slots" + " Weapon:slot machine" + " Seed:11897",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
