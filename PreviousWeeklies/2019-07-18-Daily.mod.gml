...
/*@rMods@w=#  Baldi#  Auto Bullet Shotgun#  Cuz#  Determination#  Big Toothbrush#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  Big Toothbrush#@pSeed@w=24357#Limited Tries:false*/
/*|Baldi[Baldi's Basics in Education and Learning#is a state-of-the-art, fully 3D interactive,#fun-time educational game that teaches a slew of subjects!]|Auto Bullet Shotgun[BLAM BLAM BLAMMO]|Cuz[Has an energy shield, for some reason.]|Determination[Seeing this filler text#fills you with determination]|Big Toothbrush[a big toothbrush for big mouths]*/
#define init
...
trace("Current Daily:");
trace("Mods=Baldi,Auto Bullet Shotgun,Cuz,Determination,Big Toothbrush");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Baldi,Auto Bullet Shotgun,Cuz,Determination,Big Toothbrush" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Big Toothbrush" + " Seed:24357";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-18 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-18 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-18 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-18 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-18 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Baldi,Auto Bullet Shotgun,Cuz,Determination,Big Toothbrush" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Big Toothbrush" + " Seed:24357" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Baldi,Auto Bullet Shotgun,Cuz,Determination,Big Toothbrush" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Big Toothbrush" + " Seed:24357",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
