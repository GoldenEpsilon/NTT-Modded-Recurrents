...
/*@rMods@w=#  Armageddon Cannon#  boys#  Cool Shadows#  BL2#  Adjustable Ammo#@bCharacter@w=#  Choose#@yCrown@w=#  crown of love#@gWeapon@w=#  Armageddon Cannon#@pSeed@w=26972#Limited Tries:false*/
/*|Armageddon Cannon[Some people just want to watch the world burn...]|boys[Instead of hit points, you have a 1hp clone per hit point, and max health basically doesn't exist.]|Cool Shadows[WHAT IS IT?#IT'S FOLLOWING MY EVERY MOVE!]|BL2[Borderlands 2 x Nuclear Throne]|Adjustable Ammo[Push the limits#of ammo storage!]*/
#define init
...
trace("Current Daily:");
trace("Mods=Armageddon Cannon,boys,Cool Shadows,BL2,Adjustable Ammo");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Armageddon Cannon,boys,Cool Shadows,BL2,Adjustable Ammo" + " Character:Choose" + " Crown:crown of love" + " Weapon:Armageddon Cannon" + " Seed:26972";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-12-06 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-12-06 Daily.txt");
		while(!file_loaded(global.alias + " 2019-12-06 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-12-06 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-12-06 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Armageddon Cannon,boys,Cool Shadows,BL2,Adjustable Ammo" + " Character:Choose" + " Crown:crown of love" + " Weapon:Armageddon Cannon" + " Seed:26972" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Armageddon Cannon,boys,Cool Shadows,BL2,Adjustable Ammo" + " Character:Choose" + " Crown:crown of love" + " Weapon:Armageddon Cannon" + " Seed:26972",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
