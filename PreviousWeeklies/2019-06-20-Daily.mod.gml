...
/*@rMods@w=#  Elite Turrets#  Detonator#  Champions#  Area Health#  Elite Gamers#@bCharacter@w=#  Choose#@yCrown@w=#  crown of luck#@gWeapon@w=#  guitar#@pSeed@w=24042#Limited Tries:false*/
/*|Elite Turrets[V.2.0.maybe-we-#got-all-the-bugs-#this-time]|Detonator[Active has a radius#where when you release#it blows up your bullets]|Champions[weeeee are the buffed minionssss,#my frieeeeeendssss]|Area Health[A nice mod that shows how many enemies are left.]|Elite Gamers[The bad guys got#aiming classes]*/
#define init
...
trace("Current Daily:");
trace("Mods=Elite Turrets,Detonator,Champions,Area Health,Elite Gamers");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Elite Turrets,Detonator,Champions,Area Health,Elite Gamers" + " Character:Choose" + " Crown:crown of luck" + " Weapon:guitar" + " Seed:24042";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-06-20 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-06-20 Daily.txt");
		while(!file_loaded(global.alias + " 2019-06-20 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-06-20 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-06-20 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Elite Turrets,Detonator,Champions,Area Health,Elite Gamers" + " Character:Choose" + " Crown:crown of luck" + " Weapon:guitar" + " Seed:24042" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Elite Turrets,Detonator,Champions,Area Health,Elite Gamers" + " Character:Choose" + " Crown:crown of luck" + " Weapon:guitar" + " Seed:24042",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
