...
/*@rMods@w=#  Ascension 13#  Cool Trails#  Crazy Traps#  Drama Kill#  Double Plasma Minigun#@bCharacter@w=#  crystal#@yCrown@w=#  crown of destiny#@gWeapon@w=#  doubleplasma#@pSeed@w=12298#Limited Tries:false*/
/*|Ascension 13[@qASCENSION LEVEL#15/15]|Cool Trails[Bullet trails,#for when you want to feel#like you're in the matrix]|Crazy Traps[Not only does#this place flame traps everywhere,#they have random projectiles, too!#Have fun with disc traps....]|Drama Kill[For when you want#to feel really good#for defeating Big Bandit]|Double Plasma Minigun[For when you want to#go through even more ammo]*/
#define init
...
trace("Mods=Ascension 13,Cool Trails,Crazy Traps,Drama Kill,Double Plasma Minigun");
trace("Character:crystal");
trace("Crown:crown of destiny");
trace("Weapon:doubleplasma");
trace("Seed:12298");
...
if(global.start){
	global.alias = "";
	with(Player){
		give_wep(string_trim("doubleplasma"));
		ammo[0] = 0;
		ammo[1] = 0;
		ammo[2] = 0;
		ammo[3] = 0;
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Ascension 13,Cool Trails,Crazy Traps,Drama Kill,Double Plasma Minigun" + " Character:crystal" + " Crown:crown of destiny" + " Weapon:doubleplasma" + " Seed:12298";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2020-02-02 Weekly.txt")){
		prevScores = string_load(global.alias + " 2020-02-02 Weekly.txt");
		while(!file_loaded(global.alias + " 2020-02-02 Weekly.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2020-02-02 Weekly.txt");
	}else{
		string_save(score, global.alias + " 2020-02-02 Weekly.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Ascension 13,Cool Trails,Crazy Traps,Drama Kill,Double Plasma Minigun" + " Character:crystal" + " Crown:crown of destiny" + " Weapon:doubleplasma" + " Seed:12298" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Ascension 13,Cool Trails,Crazy Traps,Drama Kill,Double Plasma Minigun" + " Character:crystal" + " Crown:crown of destiny" + " Weapon:doubleplasma" + " Seed:12298",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
