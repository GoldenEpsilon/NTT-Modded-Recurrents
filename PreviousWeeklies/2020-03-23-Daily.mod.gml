...
/*@rMods@w=#  Freak Arena#  Dogfly#  Balls#  Cool Hud#  Doctor#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  laserwrench#@pSeed@w=19941#Limited Tries:false*/
/*|Freak Arena[Do you think you can survive#in the @qFREAK ARENA???]|Dogfly[The dog guardians#learned to jump good.]|Balls[Boing. Thwakk. Boing. Boing. Thwakk. CRASH!!!]|Cool Hud[*C418 starts playing*]|Doctor[The feathery, creepy,#totally-not-about-to-#stab-you-with-a-knife#doctor is in!]*/
#define init
...
trace("Current Daily:");
trace("Mods=Freak Arena,Dogfly,Balls,Cool Hud,Doctor");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Freak Arena,Dogfly,Balls,Cool Hud,Doctor" + " Character:Choose" + " Crown:crown of protection" + " Weapon:laserwrench" + " Seed:19941";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2020-03-23 Daily.txt")){
		prevScores = string_load(global.alias + " 2020-03-23 Daily.txt");
		while(!file_loaded(global.alias + " 2020-03-23 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2020-03-23 Daily.txt");
	}else{
		string_save(score, global.alias + " 2020-03-23 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Freak Arena,Dogfly,Balls,Cool Hud,Doctor" + " Character:Choose" + " Crown:crown of protection" + " Weapon:laserwrench" + " Seed:19941" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Freak Arena,Dogfly,Balls,Cool Hud,Doctor" + " Character:Choose" + " Crown:crown of protection" + " Weapon:laserwrench" + " Seed:19941",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
