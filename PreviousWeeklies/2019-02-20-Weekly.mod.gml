...
//@rMods@w=#  Level Balls#  Nuke Launcher#  NTT X10 Ver 1.0.1#  Bloom Shader#  MS Paint Shader#@bCharacter@w=#  char_robot#@yCrown@w=#  crwn_blood#@gWeapon@w=#  wep_hyper_rifle#@pSeed@w=24170
#define init
...
trace("Mods=Level Balls, Nuke Launcher, NTT X10 Ver 1.0.1, Bloom Shader, MS Paint Shader");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Level Balls, Nuke Launcher, NTT X10 Ver 1.0.1, Bloom Shader, MS Paint Shader" + " Character=char_robot" + " Crown=crwn_blood" + " Weapon=wep_hyper_rifle" + " Seed=24170";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Level Balls, Nuke Launcher, NTT X10 Ver 1.0.1, Bloom Shader, MS Paint Shader" + " Character=char_robot" + " Crown=crwn_blood" + " Weapon=wep_hyper_rifle" + " Seed=24170" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else{
			file_delete("sha.txt");
