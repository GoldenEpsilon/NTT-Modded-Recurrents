...
//@rMods@w=#  Nuke Launcher#  Chaos Guns#  Paper Mario#  Lots O' Muts#  Bloom Shader#@bCharacter@w=#  char_rogue#@yCrown@w=#  crwn_destiny#@gWeapon@w=#  wep_seeker_shotgun#@pSeed@w=24953
#define init
...
trace("Mods=Nuke Launcher, Chaos Guns, Paper Mario, Lots O' Muts, Bloom Shader");
trace("Character=char_rogue");
trace("Crown=crwn_destiny");
trace("Weapon=wep_seeker_shotgun");
trace("Seed=24953");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Nuke Launcher, Chaos Guns, Paper Mario, Lots O' Muts, Bloom Shader" + " Character=char_rogue" + " Crown=crwn_destiny" + " Weapon=wep_seeker_shotgun" + " Seed=24953";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Nuke Launcher, Chaos Guns, Paper Mario, Lots O' Muts, Bloom Shader" + " Character=char_rogue" + " Crown=crwn_destiny" + " Weapon=wep_seeker_shotgun" + " Seed=24953" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else{
			file_delete("sha.txt");
