...
/*@rMods@w=#  Brimthrone#  basicgunallies#  blaac48#  Elite Turrets#  Crazy Bandits#@bCharacter@w=#  Choose#@yCrown@w=#  crown of luck#@gWeapon@w=#  brimthrone#@pSeed@w=19505#Limited Tries:false*/
/*|Brimthrone[A portable throne, to#know how it feels to#zap people with that laser.]|basicgunallies[Ever wanted your allies to have normal guns?#Wait - @q HE'S GOT A GRENADE LAUNCHER!#@q@qRUN!!!]|blaac48[The jungle is deeper]|Elite Turrets[V.2.0.maybe-we-#got-all-the-bugs-#this-time]|Crazy Bandits[THEY HAVE GUNS]*/
#define init
...
trace("Current Daily:");
trace("Mods=Brimthrone,basicgunallies,blaac48,Elite Turrets,Crazy Bandits");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Brimthrone,basicgunallies,blaac48,Elite Turrets,Crazy Bandits" + " Character:Choose" + " Crown:crown of luck" + " Weapon:brimthrone" + " Seed:19505";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2020-03-27 Daily.txt")){
		prevScores = string_load(global.alias + " 2020-03-27 Daily.txt");
		while(!file_loaded(global.alias + " 2020-03-27 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2020-03-27 Daily.txt");
	}else{
		string_save(score, global.alias + " 2020-03-27 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Brimthrone,basicgunallies,blaac48,Elite Turrets,Crazy Bandits" + " Character:Choose" + " Crown:crown of luck" + " Weapon:brimthrone" + " Seed:19505" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Brimthrone,basicgunallies,blaac48,Elite Turrets,Crazy Bandits" + " Character:Choose" + " Crown:crown of luck" + " Weapon:brimthrone" + " Seed:19505",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
