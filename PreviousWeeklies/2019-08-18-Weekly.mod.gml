...
/*@rMods@w=#  basicgunallies#  Discs#  Carmageddon#  Chaos Guns#  Bomber#@bCharacter@w=#  bomber#@yCrown@w=#  crown of curses#@gWeapon@w=#  Super Blunderbuss#@pSeed@w=14488#Limited Tries:false*/
/*|basicgunallies[Ever wanted your allies to have normal guns?#Wait - @q HE'S GOT A GRENADE LAUNCHER!#@q@qRUN!!!]|Discs[Because, you know, we need#MORE discs killing us.]|Carmageddon[WARNING: May contain drifting]|Chaos Guns[For when you need a bit#more chaos in your life.]|Bomber[Bombs?]*/
#define init
...
wait mod_load(string_trim("data/Weekly.mod/discs/Toxic Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Bloody Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Cannon.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Launcher.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Pistol.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Rifle.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Shotgun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Flame Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Hyper Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Lightning Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Mini Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Seeker Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Splinter Gun Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Smart Disc Gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Tools.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/discs/Disc Skill.skill.gml"));
wait mod_load(string_trim("data/Weekly.mod/carmageddon.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/Chaos Guns/Blunderbuss.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/Chaos Guns/Super Blunderbuss.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/Chaos Guns/Chaos Minigun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/Chaos Guns/Super Chaos Minigun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/Chaos Guns/Hyper Chaos Minigun.wep.gml"));
...
trace("Mods=basicgunallies,Discs,Carmageddon,Chaos Guns,Bomber");
trace("Character:bomber");
trace("Crown:crown of curses");
trace("Weapon:Super Blunderbuss");
trace("Seed:14488");
...
if(global.start){
	global.alias = "";
	with(Player){
		give_wep(string_trim("Super Blunderbuss"));
		ammo[0] = 0;
		ammo[1] = 0;
		ammo[2] = 0;
		ammo[3] = 0;
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:basicgunallies,Discs,Carmageddon,Chaos Guns,Bomber" + " Character:bomber" + " Crown:crown of curses" + " Weapon:Super Blunderbuss" + " Seed:14488";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-08-18 Weekly.txt")){
		prevScores = string_load(global.alias + " 2019-08-18 Weekly.txt");
		while(!file_loaded(global.alias + " 2019-08-18 Weekly.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-08-18 Weekly.txt");
	}else{
		string_save(score, global.alias + " 2019-08-18 Weekly.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:basicgunallies,Discs,Carmageddon,Chaos Guns,Bomber" + " Character:bomber" + " Crown:crown of curses" + " Weapon:Super Blunderbuss" + " Seed:14488" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":basicgunallies,Discs,Carmageddon,Chaos Guns,Bomber" + " Character:bomber" + " Crown:crown of curses" + " Weapon:Super Blunderbuss" + " Seed:14488",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
