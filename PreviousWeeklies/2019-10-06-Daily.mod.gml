...
/*@rMods@w=#  Chaos Guns#  CoD Proper#  blstorm#  Cool Shadows#  brad#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  Hyper Chaos Minigun#@pSeed@w=11089#Limited Tries:false*/
/*|Chaos Guns[For when you need a bit#more chaos in your life.]|blstorm[BLEED YOURSELF DRY]|Cool Shadows[WHAT IS IT?#IT'S FOLLOWING MY EVERY MOVE!]|brad[Adds Brad from LISA: the Painful RPG]*/
#define init
...
trace("Current Daily:");
trace("Mods=Chaos Guns,CoD Proper,blstorm,Cool Shadows,brad");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Chaos Guns,CoD Proper,blstorm,Cool Shadows,brad" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Hyper Chaos Minigun" + " Seed:11089";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-10-06 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-10-06 Daily.txt");
		while(!file_loaded(global.alias + " 2019-10-06 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-10-06 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-10-06 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Chaos Guns,CoD Proper,blstorm,Cool Shadows,brad" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Hyper Chaos Minigun" + " Seed:11089" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Chaos Guns,CoD Proper,blstorm,Cool Shadows,brad" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Hyper Chaos Minigun" + " Seed:11089",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
