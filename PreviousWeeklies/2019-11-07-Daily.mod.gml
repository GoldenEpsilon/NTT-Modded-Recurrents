...
/*@rMods@w=#  BAR#  Baldi#  BL2#  BadEnd#  Elite Turrets#@bCharacter@w=#  Choose#@yCrown@w=#  crown of luck#@gWeapon@w=#  Big Ass Revolver#@pSeed@w=30855#Limited Tries:false*/
/*|BAR[A Big Ass Revolver.]|Baldi[Baldi's Basics in Education and Learning#is a state-of-the-art, fully 3D interactive,#fun-time educational game that teaches a slew of subjects!]|BL2[Borderlands 2 x Nuclear Throne]|BadEnd[For when you don't want a good end.#(sit after loop 3)]|Elite Turrets[V.2.0.maybe-we-#got-all-the-bugs-#this-time]*/
#define init
...
trace("Current Daily:");
trace("Mods=BAR,Baldi,BL2,BadEnd,Elite Turrets");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:BAR,Baldi,BL2,BadEnd,Elite Turrets" + " Character:Choose" + " Crown:crown of luck" + " Weapon:Big Ass Revolver" + " Seed:30855";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-11-07 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-11-07 Daily.txt");
		while(!file_loaded(global.alias + " 2019-11-07 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-11-07 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-11-07 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:BAR,Baldi,BL2,BadEnd,Elite Turrets" + " Character:Choose" + " Crown:crown of luck" + " Weapon:Big Ass Revolver" + " Seed:30855" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":BAR,Baldi,BL2,BadEnd,Elite Turrets" + " Character:Choose" + " Crown:crown of luck" + " Weapon:Big Ass Revolver" + " Seed:30855",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
