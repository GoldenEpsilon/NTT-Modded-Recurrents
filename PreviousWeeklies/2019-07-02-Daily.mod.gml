...
/*@rMods@w=#  Elite Dasher#  Colored Palace#  Baller#  Blindness#  Champions#@bCharacter@w=#  Choose#@yCrown@w=#  none#@gWeapon@w=#  super slugger#@pSeed@w=29909#Limited Tries:false*/
/*|Elite Dasher[@qPICK UP ALL THE THINGS]|Colored Palace[Gives a palace a#well-deserved paint job.]|Baller[Fire burns...#me like fire...]|Blindness[MY GLASSES! I BROKE MY GLASSES!]|Champions[weeeee are the buffed minionssss,#my frieeeeeendssss]*/
#define init
...
trace("Current Daily:");
trace("Mods=Elite Dasher,Colored Palace,Baller,Blindness,Champions");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Elite Dasher,Colored Palace,Baller,Blindness,Champions" + " Character:Choose" + " Crown:none" + " Weapon:super slugger" + " Seed:29909";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-02 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-02 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-02 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-02 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-02 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Elite Dasher,Colored Palace,Baller,Blindness,Champions" + " Character:Choose" + " Crown:none" + " Weapon:super slugger" + " Seed:29909" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Elite Dasher,Colored Palace,Baller,Blindness,Champions" + " Character:Choose" + " Crown:none" + " Weapon:super slugger" + " Seed:29909",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
