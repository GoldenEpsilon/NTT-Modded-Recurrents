...
/*@rMods@w=#  Chaos Guns#  Devastator#  Crypt Of The Necrodancer#  Big Toothbrush#  Cool Flame#@bCharacter@w=#  Choose#@yCrown@w=#  crown of risk#@gWeapon@w=#  Big Toothbrush#@pSeed@w=27824#Limited Tries:false*/
/*|Chaos Guns[For when you need a bit#more chaos in your life.]|Devastator[Changes the devastator#to make it more interesting]|Crypt Of The Necrodancer[Move to the beat!]|Big Toothbrush[a big toothbrush for big mouths]|Cool Flame[Make all those enemies liars!##What do you mean that's#not how that works?]*/
#define init
...
trace("Current Daily:");
trace("Mods=Chaos Guns,Devastator,Crypt Of The Necrodancer,Big Toothbrush,Cool Flame");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Chaos Guns,Devastator,Crypt Of The Necrodancer,Big Toothbrush,Cool Flame" + " Character:Choose" + " Crown:crown of risk" + " Weapon:Big Toothbrush" + " Seed:27824";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-23 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-23 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-23 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-23 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-23 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Chaos Guns,Devastator,Crypt Of The Necrodancer,Big Toothbrush,Cool Flame" + " Character:Choose" + " Crown:crown of risk" + " Weapon:Big Toothbrush" + " Seed:27824" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Chaos Guns,Devastator,Crypt Of The Necrodancer,Big Toothbrush,Cool Flame" + " Character:Choose" + " Crown:crown of risk" + " Weapon:Big Toothbrush" + " Seed:27824",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
