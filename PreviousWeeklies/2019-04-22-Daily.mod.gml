...
/*@rMods@w=#  Big Dog Snipers#  Big Dog#  Elite Turrets#  Cannondemnation#  Big Bandit#@bCharacter@w=#  Choose#@yCrown@w=#  crown of risk#@gWeapon@w=#  cannondemnation#@pSeed@w=9108#Limited Tries:false*/
/*|Big Dog Snipers[The actual boss]|Big Dog[HE IS AWAKENED]|Elite Turrets[V.2.0.maybe-we-#got-all-the-bugs-#this-time]|Cannondemnation[DOOM DEATH DESTRUCTION##AND LINKIN PARK]|Big Bandit['Nuff said.]*/
#define init
...
trace("Current Daily:");
trace("Mods=Big Dog Snipers,Big Dog,Elite Turrets,Cannondemnation,Big Bandit");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Big Dog Snipers,Big Dog,Elite Turrets,Cannondemnation,Big Bandit" + " Character:Choose" + " Crown:crown of risk" + " Weapon:cannondemnation" + " Seed:9108";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-04-22 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-04-22 Daily.txt");
		while(!file_loaded(global.alias + " 2019-04-22 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-04-22 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-04-22 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Big Dog Snipers,Big Dog,Elite Turrets,Cannondemnation,Big Bandit" + " Character:Choose" + " Crown:crown of risk" + " Weapon:cannondemnation" + " Seed:9108" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Big Dog Snipers,Big Dog,Elite Turrets,Cannondemnation,Big Bandit" + " Character:Choose" + " Crown:crown of risk" + " Weapon:cannondemnation" + " Seed:9108",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
