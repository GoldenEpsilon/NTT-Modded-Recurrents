...
/*@rMods@w=#  Cricket#  Minecraft Area#  Ascension 10#  BL2#  Elite Dasher#@bCharacter@w=#  Choose#@yCrown@w=#  crown of haste#@gWeapon@w=#  Cricket#@pSeed@w=946#Limited Tries:false*/
/*|Cricket[Batter up!#...or whatever they say for cricket.]|Minecraft Area[Who Love Minecraf]|Ascension 10[ASCENSION LEVEL#10/15]|BL2[Borderlands 2 x Nuclear Throne]|Elite Dasher[@qPICK UP ALL THE THINGS]*/
#define init
...
trace("Current Daily:");
trace("Mods=Cricket,Minecraft Area,Ascension 10,BL2,Elite Dasher");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Cricket,Minecraft Area,Ascension 10,BL2,Elite Dasher" + " Character:Choose" + " Crown:crown of haste" + " Weapon:Cricket" + " Seed:946";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-11-22 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-11-22 Daily.txt");
		while(!file_loaded(global.alias + " 2019-11-22 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-11-22 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-11-22 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Cricket,Minecraft Area,Ascension 10,BL2,Elite Dasher" + " Character:Choose" + " Crown:crown of haste" + " Weapon:Cricket" + " Seed:946" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Cricket,Minecraft Area,Ascension 10,BL2,Elite Dasher" + " Character:Choose" + " Crown:crown of haste" + " Weapon:Cricket" + " Seed:946",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
