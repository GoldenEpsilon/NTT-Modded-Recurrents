...
/*@rMods@w=#  Dummy#  Crazy Traps#  Big Toothbrush#  Cooler Hud#  Ancient Hatred#@bCharacter@w=#  Choose#@yCrown@w=#  crown of ancient hatred#@gWeapon@w=#  Big Toothbrush#@pSeed@w=8498#Limited Tries:false*/
/*|Dummy[No strings on me!]|Crazy Traps[Not only does#this place flame traps everywhere,#they have random projectiles, too!#Have fun with disc traps....]|Big Toothbrush[a big toothbrush for big mouths]|Cooler Hud[Symphony of the Throne]|Ancient Hatred[Crown that trades health for rads over time]*/
#define init
...
trace("Current Daily:");
trace("Mods=Dummy,Crazy Traps,Big Toothbrush,Cooler Hud,Ancient Hatred");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Dummy,Crazy Traps,Big Toothbrush,Cooler Hud,Ancient Hatred" + " Character:Choose" + " Crown:crown of ancient hatred" + " Weapon:Big Toothbrush" + " Seed:8498";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-17 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-17 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-17 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-17 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-17 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Dummy,Crazy Traps,Big Toothbrush,Cooler Hud,Ancient Hatred" + " Character:Choose" + " Crown:crown of ancient hatred" + " Weapon:Big Toothbrush" + " Seed:8498" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Dummy,Crazy Traps,Big Toothbrush,Cooler Hud,Ancient Hatred" + " Character:Choose" + " Crown:crown of ancient hatred" + " Weapon:Big Toothbrush" + " Seed:8498",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
