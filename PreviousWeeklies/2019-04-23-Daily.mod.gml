...
/*@rMods@w=#  Cool Trails#  bossbar#  blackholes#  Blood#  Challenge Mode#@bCharacter@w=#  Choose#@yCrown@w=#  crown of love#@gWeapon@w=#  lightning pistol#@pSeed@w=10758#Limited Tries:false*/
/*|Cool Trails[Bullet trails,#for when you want to feel#like you're in the matrix]|bossbar[For when you want to know#just how close you were to looping]|blackholes[All projectiles attract enemies of the user#that means you get pulled into enemy bullets, too.#this is going to be a hard one...]|Blood[If Nuclear Throne had an M rating...]|Challenge Mode[This run's weapons are like a box of chocolates -#you finally find one you like, then you don't have it anymore.]*/
#define init
...
trace("Current Daily:");
trace("Mods=Cool Trails,bossbar,blackholes,Blood,Challenge Mode");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Cool Trails,bossbar,blackholes,Blood,Challenge Mode" + " Character:Choose" + " Crown:crown of love" + " Weapon:lightning pistol" + " Seed:10758";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-04-23 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-04-23 Daily.txt");
		while(!file_loaded(global.alias + " 2019-04-23 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-04-23 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-04-23 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Cool Trails,bossbar,blackholes,Blood,Challenge Mode" + " Character:Choose" + " Crown:crown of love" + " Weapon:lightning pistol" + " Seed:10758" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Cool Trails,bossbar,blackholes,Blood,Challenge Mode" + " Character:Choose" + " Crown:crown of love" + " Weapon:lightning pistol" + " Seed:10758",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
