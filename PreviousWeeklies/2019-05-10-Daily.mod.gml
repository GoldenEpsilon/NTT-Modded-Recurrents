...
/*@rMods@w=#  Elite Turrets#  Bitpack#  Bear#  banditstack#  Balls#@bCharacter@w=#  Choose#@yCrown@w=#  crown of blood#@gWeapon@w=#  A Fucking Gun#@pSeed@w=22473#Limited Tries:false*/
/*|Elite Turrets[V.2.0.maybe-we-#got-all-the-bugs-#this-time]|Bitpack[idk, bitflux made this]|Bear[4 da meeeeeeeeee#eeeeemez]|banditstack[Can stack bandits,#leaving the player in awe#of their balancing skills]|Balls[Boing. Thwakk. Boing. Boing. Thwakk. CRASH!!!]*/
#define init
...
trace("Current Daily:");
trace("Mods=Elite Turrets,Bitpack,Bear,banditstack,Balls");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Elite Turrets,Bitpack,Bear,banditstack,Balls" + " Character:Choose" + " Crown:crown of blood" + " Weapon:A Fucking Gun" + " Seed:22473";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-05-10 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-05-10 Daily.txt");
		while(!file_loaded(global.alias + " 2019-05-10 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-05-10 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-05-10 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Elite Turrets,Bitpack,Bear,banditstack,Balls" + " Character:Choose" + " Crown:crown of blood" + " Weapon:A Fucking Gun" + " Seed:22473" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Elite Turrets,Bitpack,Bear,banditstack,Balls" + " Character:Choose" + " Crown:crown of blood" + " Weapon:A Fucking Gun" + " Seed:22473",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
