...
/*@rMods@w=#  Damage Numbers#  CoD Proper#  Double Laser Minigun#  Big Toothbrush#  Detonator B#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  Big Toothbrush#@pSeed@w=1613#Limited Tries:false*/
/*|Damage Numbers[So you can see how good/bad#your setup is on the fly!]|Double Laser Minigun[Great for personal rave parties!]|Big Toothbrush[a big toothbrush for big mouths]|Detonator B[Alternate version, where#active blows up#your bullets anywhere]*/
#define init
...
trace("Current Daily:");
trace("Mods=Damage Numbers,CoD Proper,Double Laser Minigun,Big Toothbrush,Detonator B");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Damage Numbers,CoD Proper,Double Laser Minigun,Big Toothbrush,Detonator B" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Big Toothbrush" + " Seed:1613";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-08-29 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-08-29 Daily.txt");
		while(!file_loaded(global.alias + " 2019-08-29 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-08-29 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-08-29 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Damage Numbers,CoD Proper,Double Laser Minigun,Big Toothbrush,Detonator B" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Big Toothbrush" + " Seed:1613" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Damage Numbers,CoD Proper,Double Laser Minigun,Big Toothbrush,Detonator B" + " Character:Choose" + " Crown:crown of protection" + " Weapon:Big Toothbrush" + " Seed:1613",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
