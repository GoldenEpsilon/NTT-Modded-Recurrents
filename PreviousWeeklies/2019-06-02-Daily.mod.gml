...
/*@rMods@w=#  Elite Turrets#  Vanthro#  Colored Projectiles#  Cricket#  B#@bCharacter@w=#  Choose#@yCrown@w=#  crown of luck#@gWeapon@w=#  Cricket#@pSeed@w=4804#Limited Tries:false*/
/*|Elite Turrets[V.2.0.maybe-we-#got-all-the-bugs-#this-time]|Vanthro[...blame 4chan.]|Colored Projectiles[Colors projectiles based on team color]|Cricket[Batter up!#...or whatever they say for cricket.]|B[B]*/
#define init
...
trace("Current Daily:");
trace("Mods=Elite Turrets,Vanthro,Colored Projectiles,Cricket,B");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Elite Turrets,Vanthro,Colored Projectiles,Cricket,B" + " Character:Choose" + " Crown:crown of luck" + " Weapon:Cricket" + " Seed:4804";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-06-02 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-06-02 Daily.txt");
		while(!file_loaded(global.alias + " 2019-06-02 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-06-02 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-06-02 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Elite Turrets,Vanthro,Colored Projectiles,Cricket,B" + " Character:Choose" + " Crown:crown of luck" + " Weapon:Cricket" + " Seed:4804" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Elite Turrets,Vanthro,Colored Projectiles,Cricket,B" + " Character:Choose" + " Crown:crown of luck" + " Weapon:Cricket" + " Seed:4804",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
