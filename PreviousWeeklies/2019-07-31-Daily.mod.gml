...
/*@rMods@w=#  Cricket#  B#  Cool Dark#  Big Dog Snipers#  Cursed Hyper Crystal#@bCharacter@w=#  Choose#@yCrown@w=#  crown of risk#@gWeapon@w=#  Cricket#@pSeed@w=6849#Limited Tries:false*/
/*|Cricket[Batter up!#...or whatever they say for cricket.]|B[B]|Cool Dark[spoopy time]|Big Dog Snipers[The actual boss]|Cursed Hyper Crystal[Adds a Cursed variant of the Hyper Crystal.#If you fight it you'll probably die,#but man does it look cool.]*/
#define init
...
trace("Current Daily:");
trace("Mods=Cricket,B,Cool Dark,Big Dog Snipers,Cursed Hyper Crystal");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Cricket,B,Cool Dark,Big Dog Snipers,Cursed Hyper Crystal" + " Character:Choose" + " Crown:crown of risk" + " Weapon:Cricket" + " Seed:6849";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-31 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-31 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-31 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-31 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-31 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Cricket,B,Cool Dark,Big Dog Snipers,Cursed Hyper Crystal" + " Character:Choose" + " Crown:crown of risk" + " Weapon:Cricket" + " Seed:6849" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Cricket,B,Cool Dark,Big Dog Snipers,Cursed Hyper Crystal" + " Character:Choose" + " Crown:crown of risk" + " Weapon:Cricket" + " Seed:6849",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
