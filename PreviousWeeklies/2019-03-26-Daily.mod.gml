...
/*@rMods@w=#  Balls#  Chest Bandits#  Ash#  Challenge Test#  Carbine#@bCharacter@w=#  Choose#@yCrown@w=#  crown of hatred#@gWeapon@w=#  carbine#@pSeed@w=23677#Limited Tries:false*/
/*|Balls[Boing. Thwakk. Boing. Boing. Thwakk. CRASH!!!]|Chest Bandits[Gets rid of bandits in random areas]|Ash[Guy from The End Is Nigh.]|Challenge Test[GOTTA GO FAST]|Carbine[Pew Pew.]*/
#define init
...
trace("Current Daily:");
trace("Mods=Balls,Chest Bandits,Ash,Challenge Test,Carbine");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Balls,Chest Bandits,Ash,Challenge Test,Carbine" + " Character:Choose" + " Crown:crown of hatred" + " Weapon:carbine" + " Seed:23677";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-03-26 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-03-26 Daily.txt");
		while(!file_loaded(global.alias + " 2019-03-26 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-03-26 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-03-26 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Balls,Chest Bandits,Ash,Challenge Test,Carbine" + " Character:Choose" + " Crown:crown of hatred" + " Weapon:carbine" + " Seed:23677" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Balls,Chest Bandits,Ash,Challenge Test,Carbine" + " Character:Choose" + " Crown:crown of hatred" + " Weapon:carbine" + " Seed:23677",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
