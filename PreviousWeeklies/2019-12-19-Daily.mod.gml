...
/*@rMods@w=#  basicgunallies#  blstorm#  Armageddon Cannon#  BL2#  Ascension 10#@bCharacter@w=#  Choose#@yCrown@w=#  crown of life#@gWeapon@w=#  Armageddon Cannon#@pSeed@w=16088#Limited Tries:false*/
/*|basicgunallies[Ever wanted your allies to have normal guns?#Wait - @q HE'S GOT A GRENADE LAUNCHER!#@q@qRUN!!!]|blstorm[BLEED YOURSELF DRY]|Armageddon Cannon[Some people just want to watch the world burn...]|BL2[Borderlands 2 x Nuclear Throne]|Ascension 10[ASCENSION LEVEL#10/15]*/
#define init
...
trace("Current Daily:");
trace("Mods=basicgunallies,blstorm,Armageddon Cannon,BL2,Ascension 10");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:basicgunallies,blstorm,Armageddon Cannon,BL2,Ascension 10" + " Character:Choose" + " Crown:crown of life" + " Weapon:Armageddon Cannon" + " Seed:16088";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-12-19 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-12-19 Daily.txt");
		while(!file_loaded(global.alias + " 2019-12-19 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-12-19 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-12-19 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:basicgunallies,blstorm,Armageddon Cannon,BL2,Ascension 10" + " Character:Choose" + " Crown:crown of life" + " Weapon:Armageddon Cannon" + " Seed:16088" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":basicgunallies,blstorm,Armageddon Cannon,BL2,Ascension 10" + " Character:Choose" + " Crown:crown of life" + " Weapon:Armageddon Cannon" + " Seed:16088",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
