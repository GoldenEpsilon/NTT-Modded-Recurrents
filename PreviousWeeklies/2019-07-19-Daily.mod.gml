...
/*@rMods@w=#  Bigger Bandit#  Ash#  Champions#  Cannondemnation#  Blaac's Weapon Mutations#@bCharacter@w=#  Choose#@yCrown@w=#  crown of life#@gWeapon@w=#  cannondemnation#@pSeed@w=27877#Limited Tries:false*/
/*|Bigger Bandit[Ever gotten bored of Big Dog?]|Ash[Guy from The End Is Nigh.]|Champions[weeeee are the buffed minionssss,#my frieeeeeendssss]|Cannondemnation[DOOM DEATH DESTRUCTION##AND LINKIN PARK]|Blaac's Weapon Mutations[YOU GET A WEAPON MUTATION!#YOU GET A WEAPON MUTATION!#EVERYONE GETS A WEAPON MUTATION!!!]*/
#define init
...
trace("Current Daily:");
trace("Mods=Bigger Bandit,Ash,Champions,Cannondemnation,Blaac's Weapon Mutations");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Bigger Bandit,Ash,Champions,Cannondemnation,Blaac's Weapon Mutations" + " Character:Choose" + " Crown:crown of life" + " Weapon:cannondemnation" + " Seed:27877";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-07-19 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-07-19 Daily.txt");
		while(!file_loaded(global.alias + " 2019-07-19 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-07-19 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-07-19 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Bigger Bandit,Ash,Champions,Cannondemnation,Blaac's Weapon Mutations" + " Character:Choose" + " Crown:crown of life" + " Weapon:cannondemnation" + " Seed:27877" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Bigger Bandit,Ash,Champions,Cannondemnation,Blaac's Weapon Mutations" + " Character:Choose" + " Crown:crown of life" + " Weapon:cannondemnation" + " Seed:27877",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
