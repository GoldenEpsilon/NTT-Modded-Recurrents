...
/*@rMods@w=#  Champions#  Fire Riders#  Bandit Brute#  Crypt Of The Necrodancer#  CoD Proper#@bCharacter@w=#  Choose#@yCrown@w=#  crown of hatred#@gWeapon@w=#  lightning pistol#@pSeed@w=30442#Limited Tries:false*/
/*|Champions[weeeee are the buffed minionssss,#my frieeeeeendssss]|Fire Riders[NOTE: when the gators on your back die,#you start taking damage.]|Bandit Brute[Randomly replaces bandits with Bandit Brutes]|Crypt Of The Necrodancer[Move to the beat!]*/
#define init
...
trace("Current Daily:");
trace("Mods=Champions,Fire Riders,Bandit Brute,Crypt Of The Necrodancer,CoD Proper");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Champions,Fire Riders,Bandit Brute,Crypt Of The Necrodancer,CoD Proper" + " Character:Choose" + " Crown:crown of hatred" + " Weapon:lightning pistol" + " Seed:30442";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-06-16 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-06-16 Daily.txt");
		while(!file_loaded(global.alias + " 2019-06-16 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-06-16 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-06-16 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Champions,Fire Riders,Bandit Brute,Crypt Of The Necrodancer,CoD Proper" + " Character:Choose" + " Crown:crown of hatred" + " Weapon:lightning pistol" + " Seed:30442" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Champions,Fire Riders,Bandit Brute,Crypt Of The Necrodancer,CoD Proper" + " Character:Choose" + " Crown:crown of hatred" + " Weapon:lightning pistol" + " Seed:30442",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
