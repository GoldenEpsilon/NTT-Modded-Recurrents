...
/*@rMods@w=#  AllCrowns#  Cooler Hud#  bow#  Challenge Mode#  Doctor#@bCharacter@w=#  Choose#@yCrown@w=#  crown of life#@gWeapon@w=#  bow#@pSeed@w=28940#Limited Tries:false*/
/*|AllCrowns[Lets you choose your crown#out of all crowns#at a crown vault.]|Cooler Hud[Symphony of the Throne]|bow[It's a bow.]|Challenge Mode[This run's weapons are like a box of chocolates -#you finally find one you like, then you don't have it anymore.]|Doctor[The feathery, creepy,#totally-not-about-to-#stab-you-with-a-knife#doctor is in!]*/
#define init
...
trace("Current Daily:");
trace("Mods=AllCrowns,Cooler Hud,bow,Challenge Mode,Doctor");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:AllCrowns,Cooler Hud,bow,Challenge Mode,Doctor" + " Character:Choose" + " Crown:crown of life" + " Weapon:bow" + " Seed:28940";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2020-03-24 Daily.txt")){
		prevScores = string_load(global.alias + " 2020-03-24 Daily.txt");
		while(!file_loaded(global.alias + " 2020-03-24 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2020-03-24 Daily.txt");
	}else{
		string_save(score, global.alias + " 2020-03-24 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:AllCrowns,Cooler Hud,bow,Challenge Mode,Doctor" + " Character:Choose" + " Crown:crown of life" + " Weapon:bow" + " Seed:28940" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":AllCrowns,Cooler Hud,bow,Challenge Mode,Doctor" + " Character:Choose" + " Crown:crown of life" + " Weapon:bow" + " Seed:28940",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
