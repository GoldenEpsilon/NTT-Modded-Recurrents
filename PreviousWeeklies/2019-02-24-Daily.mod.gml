...
/*@rMods@w=#  Bear#  Ancient Hatred#  Belly#  banditstack#  Auto Flame Crossbow#  B#  Ash#  Auto Bullet Shotgun#  Balls#  Afterburn#@bCharacter@w=#  Belly#@yCrown@w=#  crown of ancient hatred#@gWeapon@w=#  A Fucking Gun#@pSeed@w=11857*/
/*#Ancient Hatred[Crown that trades health for rads over time]#B[B]#Afterburn[Buffs Flames]*/
#define init
...
trace("Current Daily:");
trace("Mods=Bear,Ancient Hatred,Belly,banditstack,Auto Flame Crossbow,B,Ash,Auto Bullet Shotgun,Balls,Afterburn");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Bear,Ancient Hatred,Belly,banditstack,Auto Flame Crossbow,B,Ash,Auto Bullet Shotgun,Balls,Afterburn" + " Character=Belly" + " Crown=crown of ancient hatred" + " Weapon=A Fucking Gun" + " Seed=11857";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Bear,Ancient Hatred,Belly,banditstack,Auto Flame Crossbow,B,Ash,Auto Bullet Shotgun,Balls,Afterburn" + " Character=Belly" + " Crown=crown of ancient hatred" + " Weapon=A Fucking Gun" + " Seed=11857" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:Bear,Ancient Hatred,Belly,banditstack,Auto Flame Crossbow,B,Ash,Auto Bullet Shotgun,Balls,Afterburn" + " Character=Belly" + " Crown=crown of ancient hatred")) > 1){
			file_delete("sha.txt");
