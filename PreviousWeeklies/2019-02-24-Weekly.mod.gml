...
/*@rMods@w=#  !ARMAGGEDNN#  2 Hour Area#  Armageddon Cannon#  6 Weapons#  Afterburn#@bCharacter@w=#  eyes#@yCrown@w=#  crown of risk#@gWeapon@w=#  wep_hyper_rifle#@pSeed@w=24312*/
#define init
...
file_delete(string_trim("2 hour area/gfx/sprBox.png"));while (file_exists(string_trim("2 hour area/gfx/sprBox.png"))) {wait 1;}wait(file_download(string_trim("https://raw.githubusercontent.com/GoldenEpsilon/NTT-Modded-Recurrents/master/WeeklyMods/2 hour area/gfx/sprBox.png"), string_trim("2 hour area/gfx/sprBox.png")));
...
while (!file_loaded(string_trim("2 hour area/gfx/sprBox.png"))) {wait 1;}
...
mod_load(string_trim("data/Weekly.mod/Armageddon_Cannon.wep.gml"));
...
trace("Mods=!ARMAGGEDNN, 2 Hour Area, Armageddon Cannon, 6 Weapons, Afterburn");
trace("Character=eyes");
trace("Crown=crown of risk");
trace("Weapon=wep_hyper_rifle");
trace("Seed=24312");
...
if(!global.canStart){with(CharSelect){instance_change(CustomObject, 0);name=mod_current;race=string_lower(string_trim("eyes"));}}
else{with(instances_matching(CustomObject, "name", mod_current)){instance_change(CharSelect, 0);}with(CharSelect){race=string_lower(string_trim("eyes"));visible=true;}}
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:!ARMAGGEDNN, 2 Hour Area, Armageddon Cannon, 6 Weapons, Afterburn" + " Character=eyes" + " Crown=crown of risk" + " Weapon=wep_hyper_rifle" + " Seed=24312";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:!ARMAGGEDNN, 2 Hour Area, Armageddon Cannon, 6 Weapons, Afterburn" + " Character=eyes" + " Crown=crown of risk" + " Weapon=wep_hyper_rifle" + " Seed=24312" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:!ARMAGGEDNN, 2 Hour Area, Armageddon Cannon, 6 Weapons, Afterburn" + " Character=eyes" + " Crown=crown of risk")) > 1){
			file_delete("sha.txt");
