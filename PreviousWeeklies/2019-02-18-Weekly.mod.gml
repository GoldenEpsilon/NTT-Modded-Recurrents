...
trace("Mods=Bloom Shader, Level Balls, Nuke Launcher, Freak Arena, Chaos Guns");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Bloom Shader, Level Balls, Nuke Launcher, Freak Arena, Chaos Guns" + " Character=char_melting" + " Crown=crwn_risk" + " Weapon=wep_grenade_shotgun" + " Seed=21094";
	}
	trace(score);
