...
trace("Mods=Level Balls, Lots O' Muts, Nuke Launcher, Paper Mario, Chaos Guns");
trace("Character=char_frog");
trace("Crown=crwn_luck");
trace("Weapon=wep_lightning_shotgun");
trace("Seed=11700");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Level Balls, Lots O' Muts, Nuke Launcher, Paper Mario, Chaos Guns" + " Character=char_frog" + " Crown=crwn_luck" + " Weapon=wep_lightning_shotgun" + " Seed=11700";
	}
	trace(score);
