...
/*@rMods@w=#  Ancient Hatred#  Balls#  Corsair#  Bioluminary Oscillator#  Carpocalypse#@bCharacter@w=#  melting#@yCrown@w=#  crown of ancient hatred#@gWeapon@w=#  Corsair#@pSeed@w=11208#Limited Tries:false*/
/*|Ancient Hatred[Crown that trades health for rads over time]|Balls[Boing. Thwakk. Boing. Boing. Thwakk. CRASH!!!]|Corsair[The Corsair from EtG#Plot A Course]|Bioluminary Oscillator[TARGET AQUIRED]|Carpocalypse[Beep Beep, motherf***er]*/
#define init
...
wait mod_load(string_trim("data/Weekly.mod/balls/balls.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/balls/laserwrench.wep.gml"));
...
trace("Mods=Ancient Hatred,Balls,Corsair,Bioluminary Oscillator,Carpocalypse");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Ancient Hatred,Balls,Corsair,Bioluminary Oscillator,Carpocalypse" + " Character:melting" + " Crown:crown of ancient hatred" + " Weapon:Corsair" + " Seed:11208";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-09-15 Weekly.txt")){
		prevScores = string_load(global.alias + " 2019-09-15 Weekly.txt");
		while(!file_loaded(global.alias + " 2019-09-15 Weekly.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-09-15 Weekly.txt");
	}else{
		string_save(score, global.alias + " 2019-09-15 Weekly.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Ancient Hatred,Balls,Corsair,Bioluminary Oscillator,Carpocalypse" + " Character:melting" + " Crown:crown of ancient hatred" + " Weapon:Corsair" + " Seed:11208" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Ancient Hatred,Balls,Corsair,Bioluminary Oscillator,Carpocalypse" + " Character:melting" + " Crown:crown of ancient hatred" + " Weapon:Corsair" + " Seed:11208",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
