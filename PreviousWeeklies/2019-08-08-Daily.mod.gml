...
/*@rMods@w=#  Big Bandit#  Confuse#  Colored Palace#  Crazy Traps#  Double Laser Minigun#@bCharacter@w=#  Choose#@yCrown@w=#  crown of curses#@gWeapon@w=#  doublelaser#@pSeed@w=20548#Limited Tries:false*/
/*|Big Bandit['Nuff said.]|Confuse[I guess you had a bit#too much to drink last night, eh?]|Colored Palace[Gives a palace a#well-deserved paint job.]|Crazy Traps[Not only does#this place flame traps everywhere,#they have random projectiles, too!#Have fun with disc traps....]|Double Laser Minigun[Great for personal rave parties!]*/
#define init
...
downloadmod("Big Bandit/bigbandit.race.gml");
downloadmod("Big Bandit/bigrifle.wep.gml");
downloadmod("Big Bandit/BigBanditA.png");
downloadmod("Big Bandit/BigBanditB.png");
downloadmod("Big Bandit/BigBanditGun.png");
downloadmod("Big Bandit/BigBanditIcon.png");
downloadmod("Big Bandit/BigBanditIconA.png");
downloadmod("Big Bandit/BigBanditIconB.png");
downloadmod("Big Bandit/BigBanditMap.png");
downloadmod("Big Bandit/BigBanditPortrait.png");
downloadmod("confuse.mod.gml");
...
trace("Current Daily:");
trace("Mods=Big Bandit,Confuse,Colored Palace,Crazy Traps,Double Laser Minigun");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Big Bandit,Confuse,Colored Palace,Crazy Traps,Double Laser Minigun" + " Character:Choose" + " Crown:crown of curses" + " Weapon:doublelaser" + " Seed:20548";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-08-08 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-08-08 Daily.txt");
		while(!file_loaded(global.alias + " 2019-08-08 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-08-08 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-08-08 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Big Bandit,Confuse,Colored Palace,Crazy Traps,Double Laser Minigun" + " Character:Choose" + " Crown:crown of curses" + " Weapon:doublelaser" + " Seed:20548" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Big Bandit,Confuse,Colored Palace,Crazy Traps,Double Laser Minigun" + " Character:Choose" + " Crown:crown of curses" + " Weapon:doublelaser" + " Seed:20548",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
