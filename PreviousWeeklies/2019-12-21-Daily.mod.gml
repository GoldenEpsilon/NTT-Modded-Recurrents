...
/*@rMods@w=#  Cricket#  Dasher#  Carmageddon#  Carbine#  Bandit Brute#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  carbine#@pSeed@w=20010#Limited Tries:false*/
/*|Cricket[Batter up!#...or whatever they say for cricket.]|Dasher[Dash at thing#-> pick up thing#-> throw thing#-> repeat.]|Carmageddon[WARNING: May contain drifting]|Carbine[Pew Pew.]|Bandit Brute[Randomly replaces bandits with Bandit Brutes]*/
#define init
...
trace("Current Daily:");
trace("Mods=Cricket,Dasher,Carmageddon,Carbine,Bandit Brute");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Cricket,Dasher,Carmageddon,Carbine,Bandit Brute" + " Character:Choose" + " Crown:crown of protection" + " Weapon:carbine" + " Seed:20010";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-12-21 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-12-21 Daily.txt");
		while(!file_loaded(global.alias + " 2019-12-21 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-12-21 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-12-21 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Cricket,Dasher,Carmageddon,Carbine,Bandit Brute" + " Character:Choose" + " Crown:crown of protection" + " Weapon:carbine" + " Seed:20010" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Cricket,Dasher,Carmageddon,Carbine,Bandit Brute" + " Character:Choose" + " Crown:crown of protection" + " Weapon:carbine" + " Seed:20010",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
