...
/*@rMods@w=#  Dasher#  Blindness#  boys#  Crypt Of The Necrodancer#  Bitpack#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  industrialshankgun#@pSeed@w=20505#Limited Tries:false*/
/*|Dasher[Dash at thing#-> pick up thing#-> throw thing#-> repeat.]|Blindness[MY GLASSES! I BROKE MY GLASSES!]|boys[Instead of hit points, you have a 1hp clone per hit point, and max health basically doesn't exist.]|Crypt Of The Necrodancer[Move to the beat!]|Bitpack[idk, bitflux made this]*/
#define init
...
trace("Current Daily:");
trace("Mods=Dasher,Blindness,boys,Crypt Of The Necrodancer,Bitpack");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Dasher,Blindness,boys,Crypt Of The Necrodancer,Bitpack" + " Character:Choose" + " Crown:crown of protection" + " Weapon:industrialshankgun" + " Seed:20505";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-09-24 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-09-24 Daily.txt");
		while(!file_loaded(global.alias + " 2019-09-24 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-09-24 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-09-24 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Dasher,Blindness,boys,Crypt Of The Necrodancer,Bitpack" + " Character:Choose" + " Crown:crown of protection" + " Weapon:industrialshankgun" + " Seed:20505" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Dasher,Blindness,boys,Crypt Of The Necrodancer,Bitpack" + " Character:Choose" + " Crown:crown of protection" + " Weapon:industrialshankgun" + " Seed:20505",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
