...
/*@rMods@w=#  All Is Minigun#  Corsair#  Double Pop Gun#  Elite Turrets 2#  Challenge Test#@bCharacter@w=#  Choose#@yCrown@w=#  crown of love#@gWeapon@w=#  double_pop_gun#@pSeed@w=24109#Limited Tries:false*/
/*|All Is Minigun[ALL WILL PERISH.#Inifinite fire rate,#no ammo concerns.]|Corsair[The Corsair from EtG#Plot A Course]|Double Pop Gun[Now you can tickle enemies#twice as fast!]|Elite Turrets 2[Electric Boogaloo.#(affects Labs turrets)]|Challenge Test[GOTTA GO FAST]*/
#define init
...
trace("Current Daily:");
trace("Mods=All Is Minigun,Corsair,Double Pop Gun,Elite Turrets 2,Challenge Test");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:All Is Minigun,Corsair,Double Pop Gun,Elite Turrets 2,Challenge Test" + " Character:Choose" + " Crown:crown of love" + " Weapon:double_pop_gun" + " Seed:24109";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-11-27 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-11-27 Daily.txt");
		while(!file_loaded(global.alias + " 2019-11-27 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-11-27 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-11-27 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:All Is Minigun,Corsair,Double Pop Gun,Elite Turrets 2,Challenge Test" + " Character:Choose" + " Crown:crown of love" + " Weapon:double_pop_gun" + " Seed:24109" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":All Is Minigun,Corsair,Double Pop Gun,Elite Turrets 2,Challenge Test" + " Character:Choose" + " Crown:crown of love" + " Weapon:double_pop_gun" + " Seed:24109",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
