...
/*@rMods@w=#  Ascension 15#  Cool Hud#  Armageddon Cannon#  Bigger Bandit#  Challenge Test#@bCharacter@w=#  Choose#@yCrown@w=#  crown of life#@gWeapon@w=#  Armageddon Cannon#@pSeed@w=22211#Limited Tries:false*/
/*|Ascension 15[@qASCENSION LEVEL#@q15/15]|Cool Hud[*C418 starts playing*]|Armageddon Cannon[Some people just want to watch the world burn...]|Bigger Bandit[Ever gotten bored of Big Dog?]|Challenge Test[GOTTA GO FAST]*/
#define init
...
trace("Current Daily:");
trace("Mods=Ascension 15,Cool Hud,Armageddon Cannon,Bigger Bandit,Challenge Test");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Ascension 15,Cool Hud,Armageddon Cannon,Bigger Bandit,Challenge Test" + " Character:Choose" + " Crown:crown of life" + " Weapon:Armageddon Cannon" + " Seed:22211";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2020-02-05 Daily.txt")){
		prevScores = string_load(global.alias + " 2020-02-05 Daily.txt");
		while(!file_loaded(global.alias + " 2020-02-05 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2020-02-05 Daily.txt");
	}else{
		string_save(score, global.alias + " 2020-02-05 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Ascension 15,Cool Hud,Armageddon Cannon,Bigger Bandit,Challenge Test" + " Character:Choose" + " Crown:crown of life" + " Weapon:Armageddon Cannon" + " Seed:22211" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Ascension 15,Cool Hud,Armageddon Cannon,Bigger Bandit,Challenge Test" + " Character:Choose" + " Crown:crown of life" + " Weapon:Armageddon Cannon" + " Seed:22211",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
