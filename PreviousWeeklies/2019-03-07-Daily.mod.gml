...
/*@rMods@w=#  bow#  bouncermini#  Cuz#  basicgunallies#  Croc Man#@bCharacter@w=#  Choose#@yCrown@w=#  crown of haste#@gWeapon@w=#  bow#@pSeed@w=29117#Limited Tries:false*/
/*|bow[It's a bow.]|bouncermini[FILL THE SKIES WITH BULLETS]|Cuz[Has an energy shield, for some reason.]|basicgunallies[Ever wanted your allies to have normal guns?#OH NO HE HAS A GRENADE LAUNCHER RUN]|Croc Man[From what I can tell you either#don't take damage from anything or#you die instantly because of that passive.]*/
#define init
...
file_delete(string_trim("basicgunallies.mod.gml"));while (file_exists(string_trim("basicgunallies.mod.gml"))) {wait 1;}wait(file_download(string_trim("https://raw.githubusercontent.com/GoldenEpsilon/NTT-Modded-Recurrents/master/WeeklyMods/basicgunallies.mod.gml"), string_trim("basicgunallies.mod.gml")));
...
while (!file_loaded(string_trim("basicgunallies.mod.gml"))) {wait 1;}
...
wait mod_load(string_trim("data/Daily.mod/basicgunallies.mod.gml"));
...
trace("Current Daily:");
trace("Mods=bow,bouncermini,Cuz,basicgunallies,Croc Man");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:bow,bouncermini,Cuz,basicgunallies,Croc Man" + " Character:Choose" + " Crown:crown of haste" + " Weapon:bow" + " Seed:;29117;";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-03-07 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-03-07 Daily.txt");
		while(!file_loaded(global.alias + " 2019-03-07 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-03-07 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-03-07 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:bow,bouncermini,Cuz,basicgunallies,Croc Man" + " Character:Choose" + " Crown:crown of haste" + " Weapon:bow" + " Seed:;29117;" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all("ods:bow,bouncermini,Cuz,basicgunallies,Croc Man" + " Character:Choose" + " Crown:crown of haste" + " Weapon:bow" + " Seed:;29117;",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
