...
/*@rMods@w=#  Big Bandit#  Big Dog Snipers#  bosshudredux#  Balls#  Cool Dust#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  laserwrench#@pSeed@w=15293#Limited Tries:false*/
/*|Big Bandit['Nuff said.]|Big Dog Snipers[The actual boss]|bosshudredux[For knowing how bad your weapons are,#every once in a while]|Balls[Boing. Thwakk. Boing. Boing. Thwakk. CRASH!!!]|Cool Dust[It's not just dust, it's#COOL DUST]*/
#define init
...
downloadmod("bigdogsnipers.mod.gml");
...
wait mod_load(string_trim("data/Daily.mod/bigdogsnipers.mod.gml"));
...
trace("Current Daily:");
trace("Mods=Big Bandit,Big Dog Snipers,bosshudredux,Balls,Cool Dust");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Big Bandit,Big Dog Snipers,bosshudredux,Balls,Cool Dust" + " Character:Choose" + " Crown:crown of protection" + " Weapon:laserwrench" + " Seed:15293";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-04-19 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-04-19 Daily.txt");
		while(!file_loaded(global.alias + " 2019-04-19 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-04-19 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-04-19 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Big Bandit,Big Dog Snipers,bosshudredux,Balls,Cool Dust" + " Character:Choose" + " Crown:crown of protection" + " Weapon:laserwrench" + " Seed:15293" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Big Bandit,Big Dog Snipers,bosshudredux,Balls,Cool Dust" + " Character:Choose" + " Crown:crown of protection" + " Weapon:laserwrench" + " Seed:15293",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
