...
/*@rMods@w=#  bouncermini#  Vanthro#  DIO#  Cool Trails#  Blood#@bCharacter@w=#  Choose#@yCrown@w=#  crown of life#@gWeapon@w=#  ultra laser pistol#@pSeed@w=20643#Limited Tries:false*/
/*|bouncermini[FILL THE SKIES WITH BULLETS]|Vanthro[...blame 4chan.]|DIO[You thought it was Fish,#@qBUT IT WAS ME, DIO!]|Cool Trails[Bullet trails,#for when you want to feel#like you're in the matrix]|Blood[If Nuclear Throne had an M rating...]*/
#define init
...
trace("Current Daily:");
trace("Mods=bouncermini,Vanthro,DIO,Cool Trails,Blood");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:bouncermini,Vanthro,DIO,Cool Trails,Blood" + " Character:Choose" + " Crown:crown of life" + " Weapon:ultra laser pistol" + " Seed:20643";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-08-19 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-08-19 Daily.txt");
		while(!file_loaded(global.alias + " 2019-08-19 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-08-19 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-08-19 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:bouncermini,Vanthro,DIO,Cool Trails,Blood" + " Character:Choose" + " Crown:crown of life" + " Weapon:ultra laser pistol" + " Seed:20643" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":bouncermini,Vanthro,DIO,Cool Trails,Blood" + " Character:Choose" + " Crown:crown of life" + " Weapon:ultra laser pistol" + " Seed:20643",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
