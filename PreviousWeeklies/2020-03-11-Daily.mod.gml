...
/*@rMods@w=#  Clasweps#  Double Maxigun#  Cool Trails#  Elite Rifle#  Fire Riders#@bCharacter@w=#  Choose#@yCrown@w=#  Choice#@gWeapon@w=#  Ringoffire#@pSeed@w=13396#Limited Tries:false*/
/*|Clasweps[You got ultra weapons,#you got zappy weapons,#call now and you'll even get#some crowns thrown in for free!]|Double Maxigun[Because miniguns#aren't cool enough]|Cool Trails[Bullet trails,#for when you want to feel#like you're in the matrix]|Elite Rifle[I'm just gonna grab that,#thank you very much.]|Fire Riders[NOTE: when the gators on your back die,#you start taking damage.]*/
#define init
...
trace("Current Daily:");
trace("Mods=Clasweps,Double Maxigun,Cool Trails,Elite Rifle,Fire Riders");
trace("Character:Choose");
trace("Crown:Choice");
trace("Weapon:Ringoffire");
trace("Seed:13396");
...
if(global.start){
	global.alias = "";
	with(Player){
		give_wep(string_trim("Ringoffire"));
		ammo[0] = 0;
		ammo[1] = 0;
		ammo[2] = 0;
		ammo[3] = 0;
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Clasweps,Double Maxigun,Cool Trails,Elite Rifle,Fire Riders" + " Character:Choose" + " Crown:Choice" + " Weapon:Ringoffire" + " Seed:13396";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2020-03-11 Daily.txt")){
		prevScores = string_load(global.alias + " 2020-03-11 Daily.txt");
		while(!file_loaded(global.alias + " 2020-03-11 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2020-03-11 Daily.txt");
	}else{
		string_save(score, global.alias + " 2020-03-11 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Clasweps,Double Maxigun,Cool Trails,Elite Rifle,Fire Riders" + " Character:Choose" + " Crown:Choice" + " Weapon:Ringoffire" + " Seed:13396" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Clasweps,Double Maxigun,Cool Trails,Elite Rifle,Fire Riders" + " Character:Choose" + " Crown:Choice" + " Weapon:Ringoffire" + " Seed:13396",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
