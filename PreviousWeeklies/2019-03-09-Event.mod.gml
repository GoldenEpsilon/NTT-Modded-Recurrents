...
/*@pDesc@w=Cool.#@rMods@w=#  Cool Dust#  Cool Flame#  Cool Shadows#  Cool Trails#@bCharacter@w=#  Choose#@yCrown@w=#  crown of guns#@gWeapon@w=#  double shotgun#@pSeed@w=13383#Limited Tries:false*/
/*|Cool Dust[It's not just dust, it's#COOL DUST]|Cool Flame[Make all those enemies liars!##What do you mean that's#not how that works?]|Cool Shadows[WHAT IS IT?#IT'S FOLLOWING MY EVERY MOVE!]|Cool Trails[Bullet trails,#for when you want to feel#like you're in the matrix]*/
#define init
...
trace("Current Event:");
trace("Mods=Cool Dust,Cool Flame,Cool Shadows,Cool Trails");
...
if(global.start){
	global.alias = "";
	with(Player){
		give_wep(string_trim("double shotgun"));
		ammo[0] = 0;
		ammo[1] = 0;
		ammo[2] = 0;
		ammo[3] = 0;
