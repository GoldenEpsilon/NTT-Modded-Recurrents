...
//@rMods@w=#  NTT X10 Ver 1.0.1#  Nuke Launcher#  Level Balls#  Bandit Cannon#  Chaos Guns#@bCharacter@w=#  char_steroids#@yCrown@w=#  crwn_hatred#@gWeapon@w=#  wep_laser_rifle#@pSeed@w=26751
#define init
...
trace("Mods=NTT X10 Ver 1.0.1, Nuke Launcher, Level Balls, Bandit Cannon, Chaos Guns");
trace("Character=char_steroids");
trace("Crown=crwn_hatred");
trace("Weapon=wep_laser_rifle");
trace("Seed=26751");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:NTT X10 Ver 1.0.1, Nuke Launcher, Level Balls, Bandit Cannon, Chaos Guns" + " Character=char_steroids" + " Crown=crwn_hatred" + " Weapon=wep_laser_rifle" + " Seed=26751";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:NTT X10 Ver 1.0.1, Nuke Launcher, Level Balls, Bandit Cannon, Chaos Guns" + " Character=char_steroids" + " Crown=crwn_hatred" + " Weapon=wep_laser_rifle" + " Seed=26751" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:NTT X10 Ver 1.0.1, Nuke Launcher, Level Balls, Bandit Cannon, Chaos Guns" + " Character=char_steroids" + " Crown=crwn_hatred")) > 1){
			file_delete("sha.txt");
