...
/*@rMods@w=#  Clasweps#  Cooler Hud#  Double Maxigun#  !ARMAGGEDNN#  Damage Numbers#@bCharacter@w=#  Choose#@yCrown@w=#  slots#@gWeapon@w=#  Ultra Screwdriver#@pSeed@w=11033#Limited Tries:false*/
/*|Clasweps[You got ultra weapons,#you got zappy weapons,#call now and you'll even get#some crowns thrown in for free!]|Cooler Hud[Symphony of the Throne]|Double Maxigun[Because miniguns#aren't cool enough]|!ARMAGGEDNN[This big mod for NTT is adding 36 new Suppa CrAzY WeaPONs##Also there is a customarea (you will die)]|Damage Numbers[So you can see how good/bad#your setup is on the fly!]*/
#define init
...
trace("Current Daily:");
trace("Mods=Clasweps,Cooler Hud,Double Maxigun,!ARMAGGEDNN,Damage Numbers");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Clasweps,Cooler Hud,Double Maxigun,!ARMAGGEDNN,Damage Numbers" + " Character:Choose" + " Crown:slots" + " Weapon:Ultra Screwdriver" + " Seed:11033";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-12-05 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-12-05 Daily.txt");
		while(!file_loaded(global.alias + " 2019-12-05 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-12-05 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-12-05 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Clasweps,Cooler Hud,Double Maxigun,!ARMAGGEDNN,Damage Numbers" + " Character:Choose" + " Crown:slots" + " Weapon:Ultra Screwdriver" + " Seed:11033" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Clasweps,Cooler Hud,Double Maxigun,!ARMAGGEDNN,Damage Numbers" + " Character:Choose" + " Crown:slots" + " Weapon:Ultra Screwdriver" + " Seed:11033",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
