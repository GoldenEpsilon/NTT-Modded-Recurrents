...
/*@rMods@w=#  Carpocalypse#  xefsstuff#  CoD Proper#  Cosmi#  Double Plasma Minigun#@bCharacter@w=#  Auditor#@yCrown@w=#  crown of curses#@gWeapon@w=#  supper slugger#@pSeed@w=32019#Limited Tries:false*/
/*|Carpocalypse[Beep Beep, motherf***er]|xefsstuff[This has a bit of everything.#A bunch of weapons, a few characters,#a butler robot#buddy thingamijig that kills guys...#@qDON'T GIVE HIM A GRENADE LAUNCHER OH N-]|Cosmi[*insert *insert *insert self insert joke here* joke here* joke here*]|Double Plasma Minigun[For when you want to#go through even more ammo]*/
#define init
...
downloadmod("Double Plasma/doubleplasma.wep.gml");
downloadmod("Double Plasma/sprDoublePlasmaMinigun.png");
wait mod_load(string_trim("data/Weekly.mod/carpocalypse.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/Auditor.race.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/CopCar.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/Patrol.race.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/poporobo.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/boollista.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cannondemnation.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/carbine.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cicada.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/clinometer.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cricket.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/flashlight.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/flywheel gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/MilkSnake.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/Serpent.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/skillshot.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/slade warhammer.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/superskillshot.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/supper slugger.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/thopha.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/trimmer.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/bullet/bullet gun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/bullet/bullet shield.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/bullet/bullet spear.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/bullet/bullet trident.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/bullet/golden bullet spear.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/cloud blaster.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/cloud cannon.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/cloud minigun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/cloud pistol.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/cloud rifle.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/cloud shotgun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/thunder cloud cannon.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/thunder cloud minigun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/thunder cloud pistol.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/thunder cloud rifle.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/cloud/thunder cloud shotgun.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/bouncer darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/golden darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/gun darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/heavy darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/hyper darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/poison darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/darts/triple darts.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/gun knuckles.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/heavy knuckles.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/knuckles.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/lead knuckles.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/lightning knuckles.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/pillbugs.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/triggerknuckles.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/xefsstuff/xefsweps/knuckles/ultra knuckles.wep.gml"));
wait mod_load(string_trim("data/Weekly.mod/codproper.mod.gml"));
wait mod_load(string_trim("data/Weekly.mod/cosmi.race.gml"));
wait mod_load(string_trim("data/Weekly.mod/Double Plasma/doubleplasma.wep.gml"));
...
trace("Mods=Carpocalypse,xefsstuff,CoD Proper,Cosmi,Double Plasma Minigun");
trace("Character:Auditor");
trace("Crown:crown of curses");
trace("Weapon:supper slugger");
trace("Seed:32019");
...
if(global.start){
	global.alias = "";
	with(Player){
		give_wep(string_trim("supper slugger"));
		ammo[0] = 0;
		ammo[1] = 0;
		ammo[2] = 0;
		ammo[3] = 0;
...
if(!global.canStart){
	...
	with(CharSelect){
		...
		if(instance_exists(self) && !ChooseCharacter){
			if(string_lower(string_trim(race))!=string_lower(string_trim("Auditor")) && fork()){
				wait(0);
				if(string_lower(string_trim(race))!=string_lower(string_trim("Auditor"))){
					instance_destroy();
				}
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:Carpocalypse,xefsstuff,CoD Proper,Cosmi,Double Plasma Minigun" + " Character:Auditor" + " Crown:crown of curses" + " Weapon:supper slugger" + " Seed:32019";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-06-16 Weekly.txt")){
		prevScores = string_load(global.alias + " 2019-06-16 Weekly.txt");
		while(!file_loaded(global.alias + " 2019-06-16 Weekly.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-06-16 Weekly.txt");
	}else{
		string_save(score, global.alias + " 2019-06-16 Weekly.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Carpocalypse,xefsstuff,CoD Proper,Cosmi,Double Plasma Minigun" + " Character:Auditor" + " Crown:crown of curses" + " Weapon:supper slugger" + " Seed:32019" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all(":Carpocalypse,xefsstuff,CoD Proper,Cosmi,Double Plasma Minigun" + " Character:Auditor" + " Crown:crown of curses" + " Weapon:supper slugger" + " Seed:32019",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
...
global.start = true;
with(Player){if(!ChooseCharacter){race=string_trim("Auditor");}else{global.Race = race;}}
