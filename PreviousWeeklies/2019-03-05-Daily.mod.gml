...
/*@rMods@w=#  C Ultras#  Cool Dust#  Balls#  Blindness#  Challenge Test#@bCharacter@w=#  Choose#@yCrown@w=#  crown of protection#@gWeapon@w=#  laserwrench#@pSeed@w=32307#Limited Tries:false*/
/*|C Ultras[Adds a C ultra to all#the vanilla characters]|Cool Dust[It's not just dust, it's#COOL DUST]|Balls[Boing. Thwakk. Boing. Boing. Thwakk. CRASH!!!]|Blindness[MY GLASSES! I BROKE MY GLASSES!]|Challenge Test[GOTTA GO FAST]*/
#define init
...
trace("Current Daily:");
trace("Mods=C Ultras,Cool Dust,Balls,Blindness,Challenge Test");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Character: " + (ChooseCharacter ? global.Race : "") + " Mods:C Ultras,Cool Dust,Balls,Blindness,Challenge Test" + " Character=Choose" + " Crown=crown of protection" + " Weapon=laserwrench" + " Seed=32307";
	}
	trace(score);
	global.finished = true;
	if(file_exists(global.alias + " 2019-03-05 Daily.txt")){
		prevScores = string_load(global.alias + " 2019-03-05 Daily.txt");
		while(!file_loaded(global.alias + " 2019-03-05 Daily.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-03-05 Daily.txt");
	}else{
		string_save(score, global.alias + " 2019-03-05 Daily.txt");
	}
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:C Ultras,Cool Dust,Balls,Blindness,Challenge Test" + " Character=Choose" + " Crown=crown of protection" + " Weapon=laserwrench" + " Seed=32307" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(string_replace_all(string_replace_all(leaderboard,chr(10),""),chr(13),""), string_replace_all(string_replace_all("ods:C Ultras,Cool Dust,Balls,Blindness,Challenge Test" + " Character=Choose" + " Crown=crown of protection" + " Weapon=laserwrench" + " Seed=32307",chr(10),""),chr(13),""))) > 1){
			var fail = 0;
