...
trace("Mods=Chaos Guns, NTT X10 Ver 1.0.1, Level Balls, Freak Arena, Lots O' Muts");
trace("Character=char_melting");
trace("Crown=crwn_haste");
trace("Weapon=wep_bouncer_smg");
trace("Seed=27788");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Chaos Guns, NTT X10 Ver 1.0.1, Level Balls, Freak Arena, Lots O' Muts" + " Character=char_melting" + " Crown=crwn_haste" + " Weapon=wep_bouncer_smg" + " Seed=27788";
	}
	trace(score);
