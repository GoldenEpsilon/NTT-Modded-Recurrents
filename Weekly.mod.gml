...
//@rMods@w=#  Bloom Shader#  Chaos Guns#  Freak Arena#  NTT X10 Ver 1.0.1#  Paper Mario#@bCharacter@w=#  char_skeleton#@yCrown@w=#  crwn_blood#@gWeapon@w=#  wep_golden_screwdriver#@pSeed@w=27277
#define init
...
trace("Mods=Bloom Shader, Chaos Guns, Freak Arena, NTT X10 Ver 1.0.1, Paper Mario");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Bloom Shader, Chaos Guns, Freak Arena, NTT X10 Ver 1.0.1, Paper Mario" + " Character=char_skeleton" + " Crown=crwn_blood" + " Weapon=wep_golden_screwdriver" + " Seed=27277";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Bloom Shader, Chaos Guns, Freak Arena, NTT X10 Ver 1.0.1, Paper Mario" + " Character=char_skeleton" + " Crown=crwn_blood" + " Weapon=wep_golden_screwdriver" + " Seed=27277" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else{
			file_delete("sha.txt");
