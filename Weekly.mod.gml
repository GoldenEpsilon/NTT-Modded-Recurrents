...
" + " Seed=10532";
	...
	if(file_exists(global.alias + " 2019-03-03 Weekly.txt")){
		prevScores = string_load(global.alias + " 2019-03-03 Weekly.txt");
		while(!file_loaded(global.alias + " 2019-03-03 Weekly.txt")){wait 1;}
		string_save(prevScores, global.alias + " 2019-03-03 Weekly.txt");
	}else{
		string_save(score, global.alias + " 2019-03-03 Weekly.txt");
	}
	if(global.qualified){
