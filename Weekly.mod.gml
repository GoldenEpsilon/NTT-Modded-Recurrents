...
trace("Mods=MS Paint Shader, Fuzzy Shader, Nuke Launcher, NTT X10 Ver 1.0.1, Bandit Cannon");
trace("Character=char_fish");
trace("Crown=crwn_life");
trace("Weapon=wep_lightning_smg");
trace("Seed=20897");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:MS Paint Shader, Fuzzy Shader, Nuke Launcher, NTT X10 Ver 1.0.1, Bandit Cannon" + " Character=char_fish" + " Crown=crwn_life" + " Weapon=wep_lightning_smg" + " Seed=20897";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 4) == "404:"){
			...
			"content":"'+base64("Mods:MS Paint Shader, Fuzzy Shader, Nuke Launcher, NTT X10 Ver 1.0.1, Bandit Cannon" + " Character=char_fish" + " Crown=crwn_life" + " Weapon=wep_lightning_smg" + " Seed=20897" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else{
			file_delete("sha.txt");
