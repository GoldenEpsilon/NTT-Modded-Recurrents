...
//@rMods@w=#  Bandit Cannon#  Paper Mario#  Level Balls#  Chaos Guns#  Nuke Launcher#@bCharacter@w=#  nukelauncher#@yCrown@w=#  crwn_luck#@gWeapon@w=#  wep_shovel#@pSeed@w=16610
#define init
...
trace("Mods=Bandit Cannon, Paper Mario, Level Balls, Chaos Guns, Nuke Launcher");
trace("Character=nukelauncher");
...
else{with(instances_matching(CustomObject, "name", mod_current)){instance_change(CharSelect, 0);}with(CharSelect){race=nukelauncher;visible=true;}}
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Bandit Cannon, Paper Mario, Level Balls, Chaos Guns, Nuke Launcher" + " Character=nukelauncher" + " Crown=crwn_luck" + " Weapon=wep_shovel" + " Seed=16610";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Bandit Cannon, Paper Mario, Level Balls, Chaos Guns, Nuke Launcher" + " Character=nukelauncher" + " Crown=crwn_luck" + " Weapon=wep_shovel" + " Seed=16610" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:Bandit Cannon, Paper Mario, Level Balls, Chaos Guns, Nuke Launcher" + " Character=nukelauncher" + " Crown=crwn_luck")) > 1){
			file_delete("sha.txt");
