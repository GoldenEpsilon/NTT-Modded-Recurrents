...
trace("Mods=Fuzzy Shader, Lots O' Muts, Paper Mario, Nuke Launcher, Freak Arena");
...
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Fuzzy Shader, Lots O' Muts, Paper Mario, Nuke Launcher, Freak Arena" + " Character=char_venuz" + " Crown=crwn_random" + " Weapon=wep_flare_gun" + " Seed=17107";
	}
	trace(score);
