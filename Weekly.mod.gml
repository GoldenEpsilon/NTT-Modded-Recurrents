...
//@rMods@w=#  Ancient Hatred#  Airhorn#  Assault Flak Cannon#  Big Bandit#  Babylon Shotgun#@bCharacter@w=#  Big Bandit#@yCrown@w=#  crown of ancient hatred#@gWeapon@w=#  wep_golden_machinegun#@pSeed@w=17356
#define init
...
mod_load(string_trim("data/Weekly.mod/ancienthatred.crown.gml"));
...
trace("Mods=Ancient Hatred, Airhorn, Assault Flak Cannon, Big Bandit, Babylon Shotgun");
trace("Character=Big Bandit");
trace("Crown=crown of ancient hatred");
trace("Weapon=wep_golden_machinegun");
trace("Seed=17356");
...
else{with(instances_matching(CustomObject, "name", mod_current)){instance_change(CharSelect, 0);}with(CharSelect){race="Big Bandit";visible=true;}}
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Ancient Hatred, Airhorn, Assault Flak Cannon, Big Bandit, Babylon Shotgun" + " Character=Big Bandit" + " Crown=crown of ancient hatred" + " Weapon=wep_golden_machinegun" + " Seed=17356";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Ancient Hatred, Airhorn, Assault Flak Cannon, Big Bandit, Babylon Shotgun" + " Character=Big Bandit" + " Crown=crown of ancient hatred" + " Weapon=wep_golden_machinegun" + " Seed=17356" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:Ancient Hatred, Airhorn, Assault Flak Cannon, Big Bandit, Babylon Shotgun" + " Character=Big Bandit" + " Crown=crown of ancient hatred")) > 1){
			file_delete("sha.txt");
