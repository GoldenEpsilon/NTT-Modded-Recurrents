...
//@rMods@w=#  Chaos Guns#  Lots O' Muts#  NTT X10 Ver 1.0.1#  Paper Mario#  Level Balls#@bCharacter@w=#  char_rogue#@yCrown@w=#  crwn_protection#@gWeapon@w=#  wep_sledgehammer#@pSeed@w=8394
#define init
...
trace("Mods=Chaos Guns, Lots O' Muts, NTT X10 Ver 1.0.1, Paper Mario, Level Balls");
trace("Character=char_rogue");
trace("Crown=crwn_protection");
trace("Weapon=wep_sledgehammer");
trace("Seed=8394");
...
else{with(instances_matching(CustomObject, "name", mod_current)){instance_change(CharSelect, 0);}with(CharSelect){race=char_rogue;visible=true;}}
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Chaos Guns, Lots O' Muts, NTT X10 Ver 1.0.1, Paper Mario, Level Balls" + " Character=char_rogue" + " Crown=crwn_protection" + " Weapon=wep_sledgehammer" + " Seed=8394";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Chaos Guns, Lots O' Muts, NTT X10 Ver 1.0.1, Paper Mario, Level Balls" + " Character=char_rogue" + " Crown=crwn_protection" + " Weapon=wep_sledgehammer" + " Seed=8394" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else if(array_length(string_split(leaderboard, "Mods:Chaos Guns, Lots O' Muts, NTT X10 Ver 1.0.1, Paper Mario, Level Balls" + " Character=char_rogue" + " Crown=crwn_protection")) > 1){
			file_delete("sha.txt");
