...
//@rMods@w=#  Lots O' Muts#  MS Paint Shader#  Paper Mario#  Level Balls#  NTT X10 Ver 1.0.1#@bCharacter@w=#  char_rebel#@yCrown@w=#  crwn_destiny#@gWeapon@w=#  wep_machinegun#@pSeed@w=8767
#define init
...
trace("Mods=Lots O' Muts, MS Paint Shader, Paper Mario, Level Balls, NTT X10 Ver 1.0.1");
...
with(CharSelect){race=char_rebel;locked = !global.canStart;}
if(!global.finished && !instance_exists(Player) && !instance_exists(Menu)){
	var score = "";
	with(GameCont){
		score = global.alias + ": Area " + string(area) + "-" + string(subarea) + " L" + string(loops) + " Kills: " + string(kills) + " Mods:Lots O' Muts, MS Paint Shader, Paper Mario, Level Balls, NTT X10 Ver 1.0.1" + " Character=char_rebel" + " Crown=crwn_destiny" + " Weapon=wep_machinegun" + " Seed=8767";
	}
	trace(score);
	...
	if(global.qualified){
		...
		if(string_copy(leaderboard, 0, 3) == "404"){
			...
			"content":"'+base64("Mods:Lots O' Muts, MS Paint Shader, Paper Mario, Level Balls, NTT X10 Ver 1.0.1" + " Character=char_rebel" + " Crown=crwn_destiny" + " Weapon=wep_machinegun" + " Seed=8767" + "|" + string_split(score, "Mods:")[0])+'"
			}'
			, "out.txt");
		}else{
			file_delete("sha.txt");
