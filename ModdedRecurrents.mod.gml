#define README
/*By @yGolden Epsilon@w##V 1.6##Adds Modded Weeklies! (and Dailies!)##@bNOTE:@w You cannot open chat while using this mod to prevent cheating##The mod list is updated at the github.##Github:#https://github.com/GoldenEpsilon/NTT-Modded-Recurrents*/
#define LOGO
...
if(mod_sideload() && instance_exists(Menu)){
	with(instances_matching(CharSelect, "visible", true)){visible=false;}
	if(button_pressed(0, "fire") && point_in_rectangle(mouse_x[0] - view_xview[0], mouse_y[0] - view_yview[0], weeklyButtonX-5, 32, weeklyButtonX + weeklyButtonW+3, weeklyButtonY + weeklyButtonH+10) && global.menu == 0){
		global.menu = -1;
	...
	if(button_pressed(0, "fire") && point_in_rectangle(mouse_x[0] - view_xview[0], mouse_y[0] - view_yview[0], weeklyButtonX-5, 32, weeklyButtonX + weeklyButtonW+3, weeklyButtonY + weeklyButtonH+10) && global.menu == 1){
		global.menu = -1;
	...
	if(button_pressed(0, "fire") && point_in_rectangle(mouse_x[0] - view_xview[0], mouse_y[0] - view_yview[0], weeklyButtonX-5, 32, weeklyButtonX + weeklyButtonW+3, weeklyButtonY + weeklyButtonH+10) && global.menu == 2){
		global.menu = -1;
...
if(mod_sideload() && instance_exists(Menu)){
	...
	draw_rectangle(global.weeklyScoreboardX, 0, global.weeklyScoreboardX+global.weeklyScoreboardW, 35, 0);
	...
	if(global.leaderboardLoaded && array_length(global.leaderboard) > 0){
		...
		draw_set_font(fntM0);
		draw_set_color(make_color_rgb(255,255,255));
		draw_text_nt(global.weeklyScoreboardX + global.weeklyScoreboardW/2 + 1, global.weeklyScoreboardY + global.weeklyScoreboardH/2 + 1, "LOADING SCORES")
