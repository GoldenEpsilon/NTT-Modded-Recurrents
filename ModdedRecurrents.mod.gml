#define README
/*By @yGolden Epsilon@w##V 1.7##Adds Modded Weeklies! (and Dailies!)##@bNOTE:@w You cannot open chat while using this mod to prevent cheating##The mod list is updated at the github.##Github:#https://github.com/GoldenEpsilon/NTT-Modded-Recurrents*/
#define LOGO
...
global.font = font_add_sprite(global.sprFont, 32, 0, -10);
...
with(instances_matching(CustomObject, "GuiPack", "gp_ticker")){
	...
	if("h" not in self){h = game_height - _y}
