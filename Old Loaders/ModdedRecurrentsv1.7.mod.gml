#define README
/*By @yGolden Epsilon@w##V 1.8##Adds Modded Weeklies! (and Dailies!)##@bNOTE:@w You cannot open chat while using this mod to prevent cheating##The mod list is updated at the github.##Github:#https://github.com/GoldenEpsilon/NTT-Modded-Recurrents*/
#define LOGO
