#define init
global.sprite = sprite_add_weapon("IceShot.png",1,2)
...
#define weapon_fire
weapon_post(6,-5,5);
sound_play_pitchvol(sndFireShotgun,1.2,1.0);
sound_play_pitchvol(sndShotgun,1.2,1.0);
repeat(6){
with instance_create(x,y,CustomProjectile){
    direction = other.gunangle + (random_range(-15,15) * other.accuracy);
    image_angle = direction;
    speed = 15 + random_range(-1,3);
