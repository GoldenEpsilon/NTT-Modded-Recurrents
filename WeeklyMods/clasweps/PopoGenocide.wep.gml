#define init
global.sprite = sprite_add_weapon("PopoGenocide.png",4,6);

#define weapon_name
return "IDPD DESTROYER";
...
#define weapon_text
return "@bPORTAL STRIKE @sPROTOTYPE";
...
sound_play_pitchvol(sndIDPDNadeExplo,0.8,2);
for(i = 65; i < 215; i += 50)
{
  ...
  motion_add(gunangle,-17);
}else{
ammo[4] = min(ammo[4] + weapon_cost(), typ_amax[4])	//give back ammo
if weapon_get_name(wep) = "IDPD DESTROYER"{
reload = 0.1
}
if weapon_get_name(bwep) = "IDPD DESTROYER"{
breload = 0.1
}
        }
}
