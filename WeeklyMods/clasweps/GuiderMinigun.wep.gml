#define init
global.sprite = sprite_add_weapon("GuidedMinigun.png",4,3);

#define weapon_name
return "GUIDER MINIGUN";
...
#define weapon_text
return "THEY COME FOR YOU";

#define weapon_fire
weapon_post(4,-4,4);
if skill_get(17){
sound_play_pitchvol(sndPlasmaMinigunUpg,1.3,1);
}else{
sound_play_pitchvol(sndPlasmaMinigun,1.3,1);
}
