#define init
global.sprite = sprite_add_weapon("ChargeCrossbow.png",2,4);

#define weapon_name
return "Charge Crossbow";
...
with creator {
    //Standard bullet creation
        with instance_create(x+lengthdir_x(6,gunangle),y+lengthdir_y(6,gunangle), Bolt){
  	speed = 18 + num
    ...
    sound_play_pitch(sndCrossbow,  .7 + .1*num)
}
