#define init
global.sprBeamer       = sprite_add_weapon("sprBeamer.png",12,6);
global.sprBeam         = sprite_add("sprBeam.png",1,0,10);
global.mskBeam         = sprite_add("mskBeam.png",1,0,10);
global.sprBeamStart    = sprite_add("sprBeamStart.png",1,12,10);
global.sprBeamCharge   = sprite_add("sprBeamCharge.png",1,16,16);
global.sprBeamEnd      = sprite_add("sprBeamEnd.png",1,10,12);
...
with instances_matching_ne(hitme,"team",other.team)
{
	if place_meeting(x,y,other)
	{
		...
		projectile_hit(self,7,1,other.direction)
