...
with enemy{
	...
	if other.charge = 1 && point_distance(x,y,other.x,other.y) < 16{
		...
		image_index = 0;
		sound_play(snd_hurt);
		my_health -= GameCont.level * (1*max(1,skill_get(5)*10)); //makes sure you dont have 0 damage
...
switch(argument0){ //ultra names
	case 1: return "Sonic Speed X10";
	case 2: return "Car Mechanic X10";
}

#define race_ultra_text 
switch (argument0){ //ultra words
	case 1: return "CHARGE STOPS WHEN NOT RIGHT-CLICKING#CHARGE SHOOTS ALOT OF BULLETS"; //ITS A MEME OK
	case 2: return "AUTO-PICKUP CARS WHILE CHARGING#CHARGE AGAIN TO THROW 10 CARS#KILLS SPAWN CARS"; //probably bad
}
