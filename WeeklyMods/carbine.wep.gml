...
global.sprCarbineF = sprite_add_weapon("iVBORw0KGgoAAAANSUhEUgAAABkAAAALCAMAAAC9KdbBAAAAD1BMVEUAAAAAAABfLybfyYb///+hP/7TAAAAAXRSTlMAQObYZgAAAD5JREFUeNqVjEESACAIAlP7/5tDyaxu7kVcZhhNRCpkIpYCKTEH/6nmj+wBdXApg5hSFogpQTWXehraDw50WIPCAN7GCvRNAAAAAElFTkSuQmCC", 4, 4);
...
if (wep = "carbine") && (ammo[1] >= 3) && (reload <= 0){
...
with(Player) if (wep = "carbine") && (carbineangle != carbineanglemax){
	if boosttime != 0{
		draw_sprite_ext(global.sprBeamW, 1, x+lengthdir_x(15, gunangle), y+lengthdir_y(15, gunangle), 1, 1, gunangle+carbineangle, c_red, beamlight)
		draw_sprite_ext(global.sprBeamW, 1, x+lengthdir_x(15, gunangle), y+lengthdir_y(15, gunangle), 1, 1, gunangle-carbineangle, c_red, beamlight)
	}
	else {
